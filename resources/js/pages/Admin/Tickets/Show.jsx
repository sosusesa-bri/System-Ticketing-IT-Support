    ...
    return (
        <AppLayout title={`Ticket ${ticket.ticket_number}`}>
            ...
            <nav className="flex items-center gap-1 text-sm text-neutral-500 mb-6">
                ...
                <Link href="/admin/tickets" className="hover:text-primary-700">All Tickets</Link>
                <ChevronRight className="h-4 w-4" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div key={comment.id} className={`flex gap-3 ${comment.is_internal ? 'bg-warning-50 -mx-2 px-2 py-2 rounded-md' : ''}`}>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {comment.is_internal && <span className="text-[10px] font-medium text-warning-600 bg-warning-100 px-1.5 py-0.5 rounded">Internal</span>}
                                ...
                                <div key={assignment.id} className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm text-neutral-600">
                                            Assigned to <strong>{assignment.assignee}</strong> by {assignment.assigner}
                                        </p>
                        ...
                        <form onSubmit={handleCommentSubmit} className="border-t border-neutral-200 pt-4">
                            ...
                            <div className="flex items-center justify-between mt-3">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span className="text-xs text-neutral-500">Internal note (not visible to user)</span>
                                </label>
                ...
                <div className="space-y-4">
                    {/* Requester info */}
                    <Card>
                        <h3 className="text-sm font-semibold text-neutral-950 mb-4">Requester</h3>
                        ...
                        <dl className="space-y-3">
                            ...
                            {ticket.due_at && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <dt className="text-xs text-neutral-500">SLA Deadline</dt>
                    ...
                    {ticket.rating && (
                        <Card>
                            <h3 className="text-sm font-semibold text-neutral-950 mb-4">User Satisfaction</h3>
                    ...
                    <Card>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-sm font-semibold text-neutral-950">Update Status</h3>
                        </div>
                    ...
                    <Card>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-sm font-semibold text-neutral-950">Assign Ticket</h3>
                        </div>
                        <form onSubmit={handleAssign} className="space-y-3">
                            <div className="space-y-1">
                                <label className="block text-xs font-medium text-neutral-500">Assign To</label>
                            ...
                            <div className="space-y-1">
                                <label className="block text-xs font-medium text-neutral-500">Notes (optional)</label>
                                <input type="text" value={assignForm.data.notes} onChange={(e) => assignForm.setData('notes', e.target.value)} placeholder="Assignment notes..." className="h-10 w-full rounded-md border border-neutral-200 bg-white px-3 text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-700" />
                            </div>
